...
public class AlltimeStandingEntries {
    private int id;
    private int alltimeStandingId;
    private int teamId;
    private Integer pos;
    ...
    public int getAlltimeStandingId() {
        return alltimeStandingId;
    }

    public void setAlltimeStandingId(int alltimeStandingId) {
    ...
    public boolean equals(Object o) {
        ...
        AlltimeStandingEntries that = (AlltimeStandingEntries) o;

        if (id != that.id) return false;
        if (alltimeStandingId != that.alltimeStandingId) return false;
    ...
    public int hashCode() {
        int result = id;
        result = 31 * result + alltimeStandingId;
