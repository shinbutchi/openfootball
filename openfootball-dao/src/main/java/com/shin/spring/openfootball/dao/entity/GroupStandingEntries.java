...
public class GroupStandingEntries {
    private int id;
    private int groupStandingId;
    private int teamId;
    private Integer pos;
    ...
    public int getGroupStandingId() {
        return groupStandingId;
    }

    public void setGroupStandingId(int groupStandingId) {
    ...
    public boolean equals(Object o) {
        ...
        GroupStandingEntries that = (GroupStandingEntries) o;

        if (id != that.id) return false;
        if (groupStandingId != that.groupStandingId) return false;
    ...
    public int hashCode() {
        int result = id;
        result = 31 * result + groupStandingId;
